  ...
  try {
    ...
    for (var p in ids) {
      ...
      try {
        ...
        var outLine = ids[p]["productId"] + "," + dataDate["cheapestUsed"] + "," + dataDate["cheapestCondition1"] + "," + dataDate["cheapestCondition2"] + "," + dataDate["sellerStarRating"] + "," + dataDate["percentPositive"];
